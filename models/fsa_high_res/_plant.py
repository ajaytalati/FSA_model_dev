...
from models.fsa_high_res._dynamics import drift_jax as _drift_jax_canonical
...
class StepwisePlant:
    ...
    def advance(self, stride_bins: int, Phi_daily: np.ndarray) -> dict:
        ...
        # historical ``sigma_S`` collision between latent-S diffusion scale
        # and stress-channel obs noise was resolved on 2026-05-06: the obs
        # entry now lives under ``sigma_S_obs``, and ``sigma_S`` here
