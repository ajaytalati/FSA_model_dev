...
def test_v5_imports_clean():
    ...
    import models.fsa_high_res as fh
...
def test_v5_estimation_propagate_fn_runs():
    ...
    from models.fsa_high_res import HIGH_RES_FSA_V5_ESTIMATION
...
def test_v5_chance_constrained_cost_smoke():
    ...
    from models.fsa_high_res import (
...
def _build_smoke_cloud(n_particles=5, n_days=14):
    ...
    from models.fsa_high_res import TRUTH_PARAMS_V5
    particles = [dict(TRUTH_PARAMS_V5) for _ in range(n_particles)]
    weights = np.ones(n_particles) / n_particles
...
def test_v5_cost_hard_jits():
    ...
    from models.fsa_high_res.control_v5 import evaluate_chance_constrained_cost_hard
...
def test_v5_cost_soft_jits():
    ...
    from models.fsa_high_res.control_v5 import evaluate_chance_constrained_cost_soft
...
def test_v5_cost_soft_grad_finite():
    ...
    from models.fsa_high_res.control_v5 import (
